...
export type Database = {
  crm: {
    Tables: {
      ...
      catalogo_sku: {
        Row: { id: string; empresa_id: string | null; proveedor: string; code: string; descripcion: string; categoria: string | null; kg_caja: number; cajas_tipo: string | null; activo: boolean | null; created_at: string | null };
        Insert: { id?: string; empresa_id?: string | null; proveedor: string; code: string; descripcion: string; categoria?: string | null; kg_caja: number; cajas_tipo?: string | null; activo?: boolean | null };
        Update: { id?: string; empresa_id?: string | null; proveedor?: string; code?: string; descripcion?: string; categoria?: string | null; kg_caja?: number; cajas_tipo?: string | null; activo?: boolean | null };
        Relationships: Empty;
      };
      bancos: {
