...
Con **Facturas ✅ LIVE** (2026-06-16), los tabs operativos de Blufin que faltan son:
...
| 5 | Supabase Storage buckets — `facturas-pdf` ✅ creado (2026-06-16, privado, política dev_open); faltan `documentos-importacion`, `logos-proveedores` | Subir pedimentos/BLs y logos |
